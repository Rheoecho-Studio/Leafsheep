...
pref("general.useragent.override.addons.mozilla.org","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.patientaccess.com","Mozilla/5.0 (%OS_SLICE% rv:60.0) Gecko/20100101 Firefox/60.0 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.soundcloud.com","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.deviantart.com","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.deviantart.net","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.altibox.dk","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.altibox.no","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.mozilla.org","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.mozilla.com","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.github.com","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
pref("general.useragent.override.zoho.com","Mozilla/5.0 (%OS_SLICE% rv:6.8) Goanna/20170101 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.facebook.com","Mozilla/5.0 (%OS_SLICE% rv:68.0) Gecko/20100101 Firefox/68.0 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.studio.youtube.com","Mozilla/5.0 (%OS_SLICE% rv:102.0) Gecko/20100101 Goanna/6.8 Firefox/102.0 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.yuku.com","Mozilla/5.0 (%OS_SLICE% rv:147.0.4) Gecko/20100101 Firefox/147.0.4 Leafsheep/1.2 SP0");
// Domains Leafsheep overrides that are not in the Pale Moon overrides
pref("general.useragent.override.slack.com","Mozilla/5.0 (%OS_SLICE% rv:120.0) Gecko/20100101 Firefox/128.0 Leafsheep/1.2 SP0");
...
pref("general.useragent.override.rheoecho.fyi","Mozilla/5.0 (%OS_SLICE% rv:147.0.4) Gecko/20100101 Firefox/147.0.4 (Leafsheep) 6.8 Goanna/6.8 Leafsheep/1.2 SP0 (LSVAPI: 1.1 , SP0 , 7fca2b8de3 )");
pref("general.useragent.override.ie.icoa.cn","Mozilla/5.0 (%OS_SLICE% rv:147.0.4) Gecko/20100101 Firefox/147.0.4 (Leafsheep) 6.8 Goanna/6.8 Leafsheep/1.2 SP0 (LSVAPI: 1.1 , SP0 , 7fca2b8de3 )");
pref("general.useragent.override.codeberg.org","Mozilla/5.0 (%OS_SLICE% rv:147.0.4) Gecko/20100101 Firefox/147.0.4 (Leafsheep) 6.8 Goanna/6.8 Leafsheep/1.2 SP0 (LSVAPI: 1.1 , SP0 , 7fca2b8de3 )");//@line 47 "/home/xxbj/Project/Leafsheep/Rolling/build/leafsheep/branding/unofficial/pref/leafsheep-branding.js"
// Geolocation
